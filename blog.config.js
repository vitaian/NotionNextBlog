...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '黑灰若山', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '吾将上下而求索', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.vitaian.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 黑灰若山', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://s2.loli.net/2023/10/02/qZPRNOpodr8ybwl.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
